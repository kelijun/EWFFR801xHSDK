...
//
 ...
 @brief  fribluetooth 的block定义和储存
...
//friBluettooth cancelScanBlock方法调用后的回调
typedef void (^BBCancelScanBlock)(CBCentralManager *centralManager);
//friBluettooth cancelAllPeripheralsConnection 方法调用后的回调
...
@interface FRICallback : NSObject
